  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <button onClick={() => navigate('/admin/users')}><StatCard label="Total Users" value={stats?.users ?? 0} icon={Users} color="indigo"  /></button>
        <button onClick={() => navigate('/admin/teams')}><StatCard label="Teams" value={stats?.teams ?? 0} icon={UsersRound} color="blue" /></button>
        <button onClick={() => navigate('/admin/projects')}><StatCard label="Projects" value={stats?.projects ?? 0} icon={FolderKanban} color="purple" /></button>
        <button onClick={() => navigate('/admin/tasks')}><StatCard label="Tasks" value={stats?.tasks ?? 0} icon={CheckSquare} color="green" /></button>
      </div>
