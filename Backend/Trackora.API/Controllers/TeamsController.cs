...
namespace Trackora.API.Controllers
{
    ...
    public class TeamsController : BaseController
    {
        ...
        public TeamsController(ITeamService teams)
        {
         ...
         [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] PaginationQuery q) => Ok(await _teams.GetAllAsync(q));
 
        [HttpGet("{id}")]
        public async Task<IActionResult> GetById(int id) => Ok(await _teams.GetByIdAsync(id));
 
        [HttpGet("my")]
        public async Task<IActionResult> GetMyTeam() => Ok(await _teams.GetTeamByMemberAsync(CurrentUserId));
 
        [HttpGet("leading")]
        public async Task<IActionResult> GetLeading() => Ok(await _teams.GetTeamsByLeaderAsync(CurrentUserId));
        ...
        {
            await _teams.DeleteAsync(id); return NoContent();
        }
        ...
        {
            await _teams.RemoveMemberAsync(id, userId); return NoContent();
        }
